...
public class CourseLoad {
    ...
    public SeatAssignment newSeatAssignment(CourseOffer co){
      ...
      public SeatAssignment newSeatAssignment(CourseOffer co,float grade){
    ...
    public ArrayList<CourseOffer> getListOfCoursesForCourseLoad(){
        ArrayList<CourseOffer> list = new ArrayList<>();
        for(SeatAssignment s:seatassignments){
            list.add(s.seat.courseoffer);
        }
        return list;
    }
